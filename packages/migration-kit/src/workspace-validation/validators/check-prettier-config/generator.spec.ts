...
describe('Check-prettier-config generator test set', () => {
    ...
    describe('Test prettier configs', () => {
        it('should not have a prettier configuration file', async () => {
            ...
            // EXPECT
            expect(data).toContainEqual({ expected: `The configuration file ${PRETTIER_CONFIG_FILE} exists.`, status: 'failed' });
        });
        ...
        it('should have a valid prettier configuration', async () => {
            ...
            const prettierConfig = `
                module.exports = {
                    ...require('./Client/dev-kit/src/prettier/index'),
                };
            `;
            ...
            // EXPECT
            expect(data).toContainEqual({ expected: `The configuration file ${PRETTIER_CONFIG_FILE} exists.`, status: 'success' });
        ...
        it('should have a prettierignore configuration file', async () => {
            ...
            // EXPECT
            expect(data).toContainEqual({ expected: `The configuration file ${PRETTIER_IGNORE_FILE} exists.`, status: 'success' });
        });
        ...
        it('should not have a prettierignore configuration file', async () => {
            ...
            // EXPECT
            expect(data).toContainEqual({ expected: `The configuration file ${PRETTIER_IGNORE_FILE} exists.`, status: 'failed' });
        });
    });
});
