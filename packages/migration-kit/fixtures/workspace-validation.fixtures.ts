...
export const generateValidatorResult = (
  status: ResultStatus
): ValidatorResultWithDoc => ({
  data: [],
  documentation: `/tree/master/Client/migration-kit/src/workspace-validation/validators/generator-id-${status}/README.md`,
  status,
});
