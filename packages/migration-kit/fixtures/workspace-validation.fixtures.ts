...
export const generateValidatorResult = (status: ResultStatus): ValidatorResultWithDoc => ({
    data: [],
    documentation: `https://vie.git.bwinparty.com/vanilla/vanilla/-/tree/master/Client/migration-kit/src/workspace-validation/validators/generator-id-${status}/README.md`,
    status,
});
